...
const Home = () => {
  ...
  return (
    ...
    <Box sx={{ width: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <Box
        sx={{width: '100%',height: '75vh',overflow: 'hidden',position: 'relative',}}
      >
        {images.map((src, index) => (
          <Box
            ...
            src={src}
            alt={`Image ${index}`}
            sx={{width: '100%',height: '100%',objectFit: 'cover',position: 'absolute',transition: 'opacity 1s ease-in-out',opacity: currentImage === index ? 1 : 0,zIndex: 1,}}
          />
        ))}
      </Box>
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      display: 'flex',flexDirection: 'column',justifyContent: 'flex-start',alignItems: 'flex-start',padding: '10px',
                    }}
                  >
